...
from logic.logic_program_basic import LogicProgramBasic
from logic.logic_program_interface import LogicProgramInterface, Solution
from logic.logic_program_optimized import LogicProgramOptimized
